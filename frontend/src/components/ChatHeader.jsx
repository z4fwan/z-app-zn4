	...
	return (
		<div className="p-2 sm:p-3 border-b flex items-center justify-between bg-base-300 text-base-content border-base-100">
			<div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
				...
				>
					<div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full overflow-hidden border-2 border-base-200 hover:border-primary transition-colors">
						<img
			...
			<div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
				<button
					className="btn btn-ghost btn-circle btn-xs sm:btn-sm hover:bg-success/20 hover:text-success transition-colors"
				...
				<button
					className="btn btn-ghost btn-circle btn-xs sm:btn-sm hover:bg-primary/20 hover:text-primary transition-colors"
